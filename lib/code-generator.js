 ...
 *        参考 https://github.com/estools/escodegen/wiki/API
 * @return {string}
 */
exports.generateModuleCode = function (moduleInfo, sourceAst, options) {
    ...
    // disable comment output because the bug `escodegen`, see
    // https://github.com/estools/escodegen/issues/336
    return escodegen.generate(ast, assign({comment: false}, options || {}));
};
